...
class Container_3cef34b8fe extends _PHPStan_7891782a6\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_3cef34b8fe $container)
			{
	...
	public function createService0796(): PHPStan\Reflection\Php\UniversalObjectCratesClassReflectionExtension
	{
		return new PHPStan\Reflection\Php\UniversalObjectCratesClassReflectionExtension(
			$this->getService('reflectionProvider'),
			['stdClass', 'Illuminate\Http\Request', 'Illuminate\Support\Optional', 'Yajra\DataTables\DataTableAbstract'],
			$this->getService('0795')
		);
	}
	...
	public function createServiceContainer(): Container_3cef34b8fe
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'universalObjectCratesClasses' => [
				...
				'Yajra\DataTables\DataTableAbstract',
			],
			'stubFiles' => [
				'phar:///Users/lahoathanh/Desktop/laravel/keyagatwo/vendor/phpstan/phpstan/phpstan.phar/stubs/Memcached.stub',
				'phar:///Users/lahoathanh/Desktop/laravel/keyagatwo/vendor/phpstan/phpstan/phpstan.phar/stubs/Redis.stub',
